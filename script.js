...
// Waits for content-loader.js to finish fetching from Supabase and
// populating the page, so reveal/counter/filter logic attaches to
// real content instead of an empty shell.
document.addEventListener('ar-content-ready', () => {
